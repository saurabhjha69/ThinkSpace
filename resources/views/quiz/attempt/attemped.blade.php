        ...
        <div id="questionsContainer" class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200" >
                        ...
                        <div class="mt-4">
                            <label for="mcq_correct" class="block text-sm font-medium text-gray-700">Correct Answer
                                (1-4)</label>
                            <input type="number"  name="mcq[{{$key+1}}][ans]" min="1" value="{{$mcq->usersAnswer[0]->ans}}"
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200" >
                        ...
                        <div class="space-y-2">
                            <label class="inline-flex items-center">
                                ...
                                {{$multians->usersAnswer[0]->choice1 ? 'checked' : ''}}
                            ...
                            <label class="inline-flex items-center">
                                ...
                                {{$multians->usersAnswer[0]->choice2 ? 'checked' : ''}}
                            ...
                            <label class="inline-flex items-center">
                                ...
                                {{$multians->usersAnswer[0]->choice3 ? 'checked' : ''}}
                            ...
                            <label class="inline-flex items-center">
                                ...
                                {{$multians->usersAnswer[0]->choice4 ? 'checked' : ''}}
            ...
            @foreach ($quiz->onelines as $key => $oneline)
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200" >
                        ...
                        <input type="text"  name="oneline[{{$key+1}}][ans]" placeholder="Enter answer" value="{{$oneline->usersAnswer[0]->ans}}"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2">
                    </div>
            @endforeach
